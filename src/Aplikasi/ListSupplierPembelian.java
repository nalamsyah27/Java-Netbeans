 ...
 * @author NAS
 */
public class ListSupplierPembelian extends javax.swing.JInternalFrame {
    Koneksi xxx;
    public Pembelian fAS=null;
    ...
    public void tarikdata(){
        ...
        fAS.ks = Table.getValueAt(tabel, 0).toString();
        fAS.ns = Table.getValueAt(tabel, 1).toString();
    }

 ...
 * @author NAS
 */
public class ListBarangPembelian extends javax.swing.JInternalFrame {
    Koneksi xxx;
    public Pembelian fAA=null;
    

    /**
     * Creates new form ListBarang
     */
    public ListBarangPembelian() {
        initComponents();
        xxx = new Koneksi();
        xxx.Koneksi();
        tampildata();
    ...
    public void tarikdata(){
        ...
        fAA.kode = Table.getValueAt(tabel, 0).toString();
        fAA.nama = Table.getValueAt(tabel, 1).toString();
        fAA.stok = Table.getValueAt(tabel, 2).toString();
        fAA.harga = Table.getValueAt(tabel, 3).toString();
    }
